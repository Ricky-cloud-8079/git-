...
namespace 期中.mydbDataSet3TableAdapters {
    ...
    public partial class 店家TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [店家] WHERE (((@IsNull_sname = 1 AND [sname] IS NULL) OR ([sname] = @Original_sname)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_number = 1 AND [number] IS NULL) OR ([number] = @Original_number)) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ([id] = @Original_id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [店家] ([sname], [address], [number], [type]) VALUES (@sname, @address," +
                " @number, @type);\r\nSELECT sname, address, number, type, id FROM 店家 WHERE (id = S" +
                "COPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [店家] SET [sname] = @sname, [address] = @address, [number] = @number, [type] = @type WHERE (((@IsNull_sname = 1 AND [sname] IS NULL) OR ([sname] = @Original_sname)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_number = 1 AND [number] IS NULL) OR ([number] = @Original_number)) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ([id] = @Original_id));
SELECT sname, address, number, type, id FROM 店家 WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT sname, address, number, type, id FROM 店家";
        ...
        public virtual int Delete(string Original_sname, string Original_address, string Original_number, string Original_type, int Original_id) {
        ...
        public virtual int Update(string sname, string address, string number, string type, string Original_sname, string Original_address, string Original_number, string Original_type, int Original_id, int id) {
            if ((sname == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string sname, string address, string number, string type, string Original_sname, string Original_address, string Original_number, string Original_type, int Original_id) {
            return this.Update(sname, address, number, type, Original_sname, Original_address, Original_number, Original_type, Original_id, Original_id);
        }
    }
