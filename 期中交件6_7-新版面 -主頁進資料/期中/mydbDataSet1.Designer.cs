...
namespace 期中 {
    ...
    public partial class mydbDataSet1 : global::System.Data.DataSet {
        ...
        public partial class productsDataTable : global::System.Data.TypedTableBase<productsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public productsRow AddproductsRow(string pname, int price, string pimage) {
...
namespace 期中.mydbDataSet1TableAdapters {
    ...
    public partial class productsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[products] WHERE (([id] = @Original_id) AND ((@IsNull_pname = 1 AND [pname] IS NULL) OR ([pname] = @Original_pname)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_pimage = 1 AND [pimage] IS NULL) OR ([pimage] = @Original_pimage)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[products] ([pname], [price], [pimage]) VALUES (@pname, @price," +
                " @pimage);\r\nSELECT id, pname, price, pimage FROM products WHERE (id = SCOPE_IDEN" +
                "TITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[products] SET [pname] = @pname, [price] = @price, [pimage] = @pimage WHERE (([id] = @Original_id) AND ((@IsNull_pname = 1 AND [pname] IS NULL) OR ([pname] = @Original_pname)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_pimage = 1 AND [pimage] IS NULL) OR ([pimage] = @Original_pimage)));
SELECT id, pname, price, pimage FROM products WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, pname, price, pimage FROM dbo.products";
        ...
        public virtual int Fill(mydbDataSet1.productsDataTable dataTable) {
        ...
        public virtual mydbDataSet1.productsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            mydbDataSet1.productsDataTable dataTable = new mydbDataSet1.productsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(mydbDataSet1.productsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_pname, global::System.Nullable<int> Original_price, string Original_pimage) {
            ...
            if ((Original_pimage == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_pimage));
            }
        ...
        public virtual int Insert(string pname, global::System.Nullable<int> price, string pimage) {
            if ((pname == null)) {
            ...
            if ((pimage == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(pimage));
            }
        ...
        public virtual int Update(string pname, global::System.Nullable<int> price, string pimage, int Original_id, string Original_pname, global::System.Nullable<int> Original_price, string Original_pimage, int id) {
            if ((pname == null)) {
            ...
            if ((pimage == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(pimage));
            }
            ...
            if ((Original_pimage == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_pimage));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string pname, global::System.Nullable<int> price, string pimage, int Original_id, string Original_pname, global::System.Nullable<int> Original_price, string Original_pimage) {
            return this.Update(pname, price, pimage, Original_id, Original_pname, Original_price, Original_pimage, Original_id);
        }
    }
