...
namespace 期中 {
    ...
    public partial class mydbDataSet2 : global::System.Data.DataSet {
        ...
        public partial class 學生DataTable : global::System.Data.TypedTableBase<學生Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public 學生Row Add學生Row(string stName) {
...
namespace 期中.mydbDataSet2TableAdapters {
    ...
    public partial class 學生TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [學生] WHERE (((@IsNull_stName = 1 AND [stName] IS NULL) OR ([stName] =" +
                " @Original_stName)) AND ([id] = @Original_id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [學生] ([stName]) VALUES (@stName);\r\nSELECT stName, id FROM 學生 WHERE (i" +
                "d = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [學生] SET [stName] = @stName WHERE (((@IsNull_stName = 1 AND [stName] IS NU" +
                "LL) OR ([stName] = @Original_stName)) AND ([id] = @Original_id));\r\nSELECT stName" +
                ", id FROM 學生 WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT stName, id FROM 學生";
        ...
        public virtual int Fill(mydbDataSet2.學生DataTable dataTable) {
        ...
        public virtual mydbDataSet2.學生DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            mydbDataSet2.學生DataTable dataTable = new mydbDataSet2.學生DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(mydbDataSet2.學生DataTable dataTable) {
        ...
        public virtual int Delete(string Original_stName, int Original_id) {
        ...
        public virtual int Insert(string stName) {
            if ((stName == null)) {
        ...
        public virtual int Update(string stName, string Original_stName, int Original_id, int id) {
            if ((stName == null)) {
            ...
            if ((Original_stName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_stName));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string stName, string Original_stName, int Original_id) {
            return this.Update(stName, Original_stName, Original_id, Original_id);
        }
    }
